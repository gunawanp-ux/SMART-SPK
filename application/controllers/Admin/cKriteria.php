...
class cKriteria extends CI_Controller
{
	...
	public function analisis()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->load->view('Admin/Layouts/head');
			$this->load->view('Admin/Layouts/header');
			$this->load->view('Admin/Kriteria/vKriteriaAnalisis', $data);
			$this->load->view('Admin/Layouts/footer');
		} else {
			$data = array(
				'range_analisis' => $this->input->post('range'),
				'nilai_analisis' => $this->input->post('nilai')
			);
			$this->mKriteria->insertAnalisis($data);
			$this->session->set_flashdata('success', 'Data Kriteria Analisis Berhasil Ditambahkan!!!');
			redirect('Admin/cKriteria/analisis', 'refresh');
		}
	}
	public function updateAnalisis($id)
	{
		...
		$this->mKriteria->updateAnalisis($id, $data);
		$this->session->set_flashdata('success', 'Data Kriteria Analisis Berhasil Diperbaharui!!!');
		redirect('Admin/cKriteria/analisis', 'refresh');
	}
	public function deleteAnalisis($id)
	{
		$this->mKriteria->deleteAnalisis($id);
		$this->session->set_flashdata('success', 'Data Kriteria Analisis Berhasil Dihapus!!!');
		redirect('Admin/cKriteria/analisis', 'refresh');
	}
}
