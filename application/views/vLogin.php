			...
			<div class="row align-items-center ">
				<div class="col-md-12">
					<div class="card-body">
						...
						<h4 class="mb-3 f-w-400">SD 4 Jaraksari</h4>
						<?php
						...
						<form action="<?= base_url('cLogin') ?>" method="POST">
							...
							<div class="form-group mb-3">
								<input type="text" name="username" class="form-control" id="Email" placeholder="Username" value="edi">
								<?= form_error('username', '<small class="text-danger">', '</small>') ?>
							</div>
							<div class="form-group mb-4">
								<input type="password" name="password" class="form-control" id="Password" placeholder="Password" value="edi">
