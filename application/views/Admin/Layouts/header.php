<body class="">
			...
			<div class="navbar-content scroll-div ">
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item pcoded-hasmenu">
						<a href="<?= base_url('Admin/cKriteria') ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-box"></i></span><span class="pcoded-mtext">Kriteria</span></a>
						<ul class="pcoded-submenu">
							...
							<li><a href="<?= base_url('Admin/cKriteria/analisis') ?>">Kriteria Analisis</a></li>
						</ul>
					</li>
					<li class="nav-item">
	...
	<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
		...
		<div class="m-header">
			<a class="mobile-menu" id="mobile-collapse" href="#!" onclick="document.querySelector('.pcoded-navbar').classList.toggle('navbar-collapsed')"><span></span></a>
